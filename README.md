## ros2cli_common_extensions (rolling) - 0.6.1-1

The packages in the `ros2cli_common_extensions` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ros2cli_common_extensions` on `Thu, 03 Sep 2026 11:16:45 -0000`
...
## ros2cli_common_extensions (rolling) - 0.6.0-1

The packages in the `ros2cli_common_extensions` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ros2cli_common_extensions` on `Wed, 06 May 2026 18:20:25 -0000`
...
## ros2cli_common_extensions (humble) - 0.1.2-1

The packages in the `ros2cli_common_extensions` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble ros2cli_common_extensions` on `Wed, 10 Dec 2025 14:08:12 -0000`
...
## ros2cli_common_extensions (jazzy) - 0.3.1-1

The packages in the `ros2cli_common_extensions` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy ros2cli_common_extensions` on `Wed, 10 Dec 2025 13:33:02 -0000`
...
## ros2cli_common_extensions (kilted) - 0.4.1-1

The packages in the `ros2cli_common_extensions` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted ros2cli_common_extensions` on `Wed, 10 Dec 2025 13:19:07 -0000`
...
## ros2cli_common_extensions (rolling) - 0.5.2-1

The packages in the `ros2cli_common_extensions` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ros2cli_common_extensions` on `Wed, 10 Dec 2025 11:21:07 -0000`
...
## ros2cli_common_extensions (rolling) - 0.5.1-1

The packages in the `ros2cli_common_extensions` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ros2cli_common_extensions` on `Tue, 01 Jul 2025 15:11:05 -0000`
...
## ros2cli_common_extensions (rolling) - 0.5.0-1
